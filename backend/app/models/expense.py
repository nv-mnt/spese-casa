...
class Expense(Base, SoftDeleteMixin):
    """Una riga del registro spese."""

    __tablename__ = "expenses"
    __table_args__ = (CheckConstraint("importo > 0", name="ck_expense_importo_positivo"),)
    ...
    paid_by: Mapped[Member] = relationship(back_populates="expenses", lazy="joined")
